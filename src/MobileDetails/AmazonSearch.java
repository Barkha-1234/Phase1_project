...
public class AmazonSearch {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Search results" +phone.size());
		
		for(int count=0;count<phone.size();count++)
		{
			if(phone.get(count).getText().toLowerCase().contains("iphone 12"))
			{
				System.out.println("Iphone name:"+phone.get(count).getText()+"Iphone price:"+price.get(count).getText());
			}
		}
